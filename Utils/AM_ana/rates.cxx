...
void rates::get_rates(bool fe)
{
  ...
  for (int j=0;j<n_entries;++j)
  {
    ...
    {     
      ...
      if (m_stub_tp[i]>=0 && fabs(IP)<1.)          is_prim=true; // OK, perfectible
