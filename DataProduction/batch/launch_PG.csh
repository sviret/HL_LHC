...
set STEP   = ${1}   # PR or BG
set MATTER = ${2}   # Directory where the bank root files are
set SECID  = ${3}   # The sector number  
set NTOT   = ${4}   # How many events in total (PR step)?
set NPFILE = ${5}   # How many events per job (PR step)?
